        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-3xl bg-gradient-to-br from-ornamental-50 to-ornamental-100 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-2xl font-script font-bold text-ornamental-800 mb-4">
                Misión
              </h3>
            ...
            <div className="text-center p-8 rounded-3xl bg-gradient-to-br from-nature-50 to-nature-100 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-2xl font-script font-bold text-nature-800 mb-4">
                Visión
              </h3>
            ...
            <div className="text-center p-8 rounded-3xl bg-gradient-to-br from-ornamental-50 to-nature-50 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-2xl font-script font-bold text-gray-800 mb-4">
                Valores
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Calidad, innovación, sostenibilidad y compromiso con la
                satisfacción del cliente guían cada uno de nuestros proyectos.
              </p>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Desde 1995, Jardinería Ornamental ha sido pionera en el
                  cuidado profesional de espacios verdes. Lo que comenzó como
                  una pequeña empresa familiar se ha convertido en líder
                  regional en servicios de jardinería.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Hoy combinamos la experiencia tradicional con tecnología de
                  vanguardia, ofreciendo soluciones automatizadas que mantienen
                  la belleza natural de cada jardín con precisión y eficiencia.
                </p>
              </div>
